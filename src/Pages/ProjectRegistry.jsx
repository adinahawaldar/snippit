...
const ProjectArchive = () => {
  ...
  const projects = [
    {
      name: "NeuralEngine Core",
      desc: "Rust-based inference engine for edge deployment.",
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?q=80&w=800",
      github: "https://github.com/",
      demo: "https://demo.com/",
      category: "Tools",
      stars: "2.5k",
    ...
    {
      name: "Lumina UI",
      desc: "Headless component library for dashboards.",
    ...
    {
        name: "Omni Vision",
        desc: "Real-time object detection using Yolov8.",
        img: "https://images.unsplash.com/photo-1527430253228-e63688615391?q=80&w=800",
        github: "https://github.com/",
        demo: "https://demo.com/",
        category: "AI/ML",
        stars: "1.5k",
      ...
      <main className="max-w-6xl mx-auto px-6 py-20 relative z-10">
        ...
        <footer className="mt-32 pt-8 border-t border-zinc-900 flex justify-between items-center opacity-30">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-500">Project_Hash_ID_992</span>
          </div>
